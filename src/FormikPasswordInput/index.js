...
export const DefaultPasswordInputStyles = StyleSheet.create({
  ...
  inputRightIconPressableContainer: {
    justifyContent: 'center',
  },
  inputRightIcon: {
    width: 18,
  ...
  const renderFieldLabel = () => {
    if (renderLabel !== undefined) {
      ...
      if (typeof renderLabel === 'function') {
        return renderLabel(name);
      }
    }
    return (
      <Text style={passwordInputStyles.label}>
        {label}&nbsp;{isRequired ? <Text style={passwordInputStyles.required}>*</Text> : null}
      </Text>
    );
  };
      ...
      {!showAdvice ? (
        <View>
          <View
            ...
            <TextInput
              ...
              onBlur={() => {
                onBlur(name);
                setAdviceVisibility(false);
                setOnFocus(false);
              }}
              onFocus={() => {
                setAdviceVisibility(true);
                setOnFocus(true);
            ...
            <Pressable
              style={passwordInputStyles.inputRightIconPressableContainer}
              onPress={togglePasswordTextEntry}
              hitSlop={{ bottom: 15, left: 10, right: 10, top: 15 }}>
              <Image
                source={iconName === 'eye' ? require('./res/eye.png') : require('./res/eye-closed.png')}
        ...
        <View style={[passwordInputStyles.passwordAdviceWrapper, areAdvicesVisible ? passwordInputStyles.passwordAdviceWrapperShadow : {}]}>
          <View
            ...
            <Pressable style={passwordInputStyles.inputRightIconPressableContainer} onPress={togglePasswordTextEntry}>
              <Image
                source={iconName === 'eye' ? require('./res/eye.png') : require('./res/eye-closed.png')}
                style={passwordInputStyles.inputRightIcon}
              />
          ...
          {areAdvicesVisible ? (
            <View style={passwordInputStyles.validationRulesContainer} onLayout={onAdvicesLayout}>
              <View style={passwordInputStyles.validationRulesWrapper}>
                <Image source={leastOneUpper ? success : fail} style={passwordInputStyles.validationImage} />
                <Text style={passwordInputStyles.validationText}>Almeno 1 lettera maiuscola</Text>
              </View>
              <View style={passwordInputStyles.validationRulesWrapper}>
                <Image source={leastOneLower ? success : fail} style={passwordInputStyles.validationImage} />
                <Text style={passwordInputStyles.validationText}>Almeno 1 lettera minuscola</Text>
              </View>
              <View style={passwordInputStyles.validationRulesWrapper}>
                <Image source={leastOneNumber ? success : fail} style={passwordInputStyles.validationImage} />
                <Text style={passwordInputStyles.validationText}>Almeno 1 numero</Text>
              </View>
              <View style={passwordInputStyles.validationRulesWrapper}>
                <Image source={leastEightChar ? success : fail} style={passwordInputStyles.validationImage} />
                <Text style={passwordInputStyles.validationText}>Almeno 8 caratteri</Text>
              </View>
            </View>
          ) : null}
        </View>
